 ...
 * changes for nuclearutil: acuicultor <ramoncuenca4@gmail.com>
 *
 ...
 * @sg_policy: nuclearutil policy object to compute the new frequency for.
 ...
 */
unsigned long nuclearutil_freq_util(int cpu, unsigned long util,
...
static unsigned long sugov_get_util(struct sugov_cpu *sg_cpu)
{
	...
	return nuclearutil_freq_util(sg_cpu->cpu, util, max, FREQUENCY_UTIL);
}
#endif
...
static struct cpufreq_governor nuclearutil_gov;
...
#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_NUCLEARUTIL
struct cpufreq_governor *cpufreq_default_governor(void)
{
	return &nuclearutil_gov;
}
#endif

static int __init sugov_register(void)
{
	return cpufreq_register_governor(&nuclearutil_gov);
}
